# Embedded C to interface LM35 temperature sensor with LPC1768 ARM Microcontroller to estimate temperature and display it on external LCD using an Analog to Digital converter
